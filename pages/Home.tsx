...
const Home: React.FC = () => {
  ...
  return (
    <div className="overflow-hidden bg-black text-white">
      ...
      <section className="relative min-h-screen flex items-center pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <img
            ...
            className="w-full h-full object-cover opacity-60 animate-[kenburnsShift_30s_ease-in-out_infinite]"
            // 👇 THIS is the “push down 70%” control:
            style={{ ['--heroShift' as any]: '70%' }}
          />
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <div className="flex flex-col sm:flex-row gap-5 mb-16 animate-in fade-in slide-in-from-bottom-6 duration-1000 delay-300">
              <Link
                to="/lessons"
                className="px-12 py-6 bg-primary-400 hover:bg-white text-black font-black rounded-full transition-all flex items-center justify-center gap-3 text-xs uppercase tracking-widest shadow-[0_0_50px_rgba(212,175,55,0.4)] hover:scale-105 active:scale-95"
              >
              ...
              <Link
                to="/book"
                className="px-12 py-6 bg-white/5 hover:bg-white/20 text-white font-black rounded-full backdrop-blur-md transition-all border border-white/20 flex items-center justify-center gap-3 text-xs uppercase tracking-widest hover:scale-105 active:scale-95"
              >
                Book for Event
              </Link>
            </div>
        ...
        <div className="absolute right-10 bottom-24 hidden lg:flex flex-col items-center gap-10">
          <span className="text-[10px] font-black uppercase tracking-[0.5em] rotate-90 text-zinc-600 origin-center whitespace-nowrap">
            Scroll for Rhythm
          </span>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <p className="text-zinc-500 max-w-2xl mx-auto text-lg">
              Whether you&apos;re looking to learn a new skill, plan a dream wedding, or impress at your next corporate event.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter mb-4">
              Trusted <span className="text-primary-400">Partners</span>
            </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 max-w-5xl mx-auto">
            {TRUSTED_PARTNERS.map((partner, idx) => (
              <div key={idx} className="group p-8 rounded-[2rem] bg-zinc-900/20 border border-white/5 hover:border-primary-400/30 transition-all flex flex-col items-center justify-center text-center hover:-translate-y-1">
                ...
                <h4 className="text-lg font-black uppercase tracking-tighter mb-1 text-zinc-300 group-hover:text-primary-400 transition-colors">
                  {partner.name}
                </h4>
      ...
      {/* ================= ANIMATIONS ================= */}
      <style>{`
        /* ✅ Ken Burns animation that ALWAYS includes your downward shift */
        @keyframes kenburnsShift {
          0%   { transform: translateY(var(--heroShift)) scale(1); }
          50%  { transform: translateY(calc(var(--heroShift) - 2%)) scale(1.1); }
          100% { transform: translateY(var(--heroShift)) scale(1); }
        }
      `}</style>
    </div>
  );
