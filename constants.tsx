...
export const MOCK_INSTRUCTORS = [
  {
    ...
    bio: 'Former World Dance Champion originally from Montana. Expert in Salsa, Bachata, Cha-Cha, Swing, and Line Dancing with over 20 years of professional experience.',
    styles: ['Salsa', 'Bachata', 'Cha-Cha', 'Swing', 'Line Dancing'],
    photoUrl: 'https://drive.google.com/file/d/1Kev8NXSZ8aVMYL2ycyhWlHhwSwl2OEHa/view?usp=sharing',
